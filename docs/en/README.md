...
> **Origin:** This project is a conversion of a **SuperFish / Koi-Pro Fish Feeder** (an automatic feeder by Aquadistri — [product range](https://aquadistri.com/de/brands/koi-pro/einrichtung-zubehoer/zubehoer/) · [original manual (PDF)](../Koi-Pro-FishFeeder-Original-Manual.pdf)) — it replaces the defective original timer board. **The case back and the PCB follow the dimensions of the original controller**, so both fit exactly into the existing housing.
