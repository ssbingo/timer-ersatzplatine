...
> **Herkunft:** Dieses Projekt ist der Umbau eines **SuperFish / Koi-Pro Fish Feeder** (Futterautomat von Aquadistri — [Produktreihe](https://aquadistri.com/de/brands/koi-pro/einrichtung-zubehoer/zubehoer/) · [Original-Handbuch (PDF)](docs/Koi-Pro-FishFeeder-Original-Manual.pdf)) — die defekte originale Zeitschaltplatine wird ersetzt. **Gehäuse-Rückteil und Platine orientieren sich an den Maßen der Originalsteuerung**, damit beides exakt in das vorhandene Gehäuse passt.
